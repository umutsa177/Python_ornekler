...
5- kullanıcının belirlediği paritenin
   ...
   kullanıcının belirlediği değerin grafiğini çizdirin (veriler sqlite tan  çekilecek)
"""
import os
import zipfile
import pandas as pd
...
if not os.path.exists("veri"):
    os.mkdir('veri')
    pariteler = zipfile.ZipFile('pariteler_cikti_1hour_2022_2022.zip')
    pariteler.extractall("veri/")
